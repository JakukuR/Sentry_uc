...
def generate_launch_description():
    ...
    frame_id2 = LaunchConfiguration('frame_id2')
    ...
    'frame_id1',
    default_value='laser_frame1',
    )
    declare_frame_id2_cmd = DeclareLaunchArgument(
    'frame_id2',
    default_value='laser_frame2',
    )
    ...
    ld.add_action(declare_frame_id2_cmd)
