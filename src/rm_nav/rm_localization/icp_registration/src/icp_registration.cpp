...
IcpNode::addNorm(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud) {
  ...
  // pose_msg.pose.position.x = map_to_odom_.transform.translation.x;
  // pose_msg.pose.position.y = map_to_odom_.transform.translation.y;
  // pose_msg.pose.position.z = map_to_odom_.transform.translation.z;

  // pose_msg.pose.orientation.w = map_to_odom_.transform.rotation.w;
  // pose_msg.pose.orientation.x = map_to_odom_.transform.rotation.x;
  // pose_msg.pose.orientation.y = map_to_odom_.transform.rotation.y;
  // pose_msg.pose.orientation.z = map_to_odom_.transform.rotation.z;
