...
#ifndef SR_OMNI_PID_PURSUIT_CONTROLLER__OMNI_PID_PURSUIT_CONTROLLER_HPP_
#define SR_OMNI_PID_PURSUIT_CONTROLLER__OMNI_PID_PURSUIT_CONTROLLER_HPP_
...
namespace sr_omni_pid_pursuit_controller
{
...
protected:
  ...
  //ROS2允许节点在运行时动态调整参数:rclcpp::node_interfaces::OnSetParametersCallbackHandle & std::mutex 来实现线程安全的参数更新
  std::mutex mutex_;
