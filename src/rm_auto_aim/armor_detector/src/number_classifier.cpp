  ...
  armors.erase(
    std::remove_if(
      ...
      [this](const Armor & armor) {
        ...
        // ignore_classes_.push_back("negative");

        //不击打的数字
        if (armor.number == unrecognized_num_[0]) {
          return true;
        }
        if (armor.number == unrecognized_num_[1]) {
          return true;
        }
        if (armor.number == unrecognized_num_[2]) {
          return true;
        }
        if (armor.number == unrecognized_num_[3]) {
          return true;
        }
        if (armor.number == unrecognized_num_[4]) {
          return true;
        }
